                                    ...
                                    <div className="product-item swiper-slide">
                                        <figure>
                                            <a href="index.html" title="Product Title">
                                                <img src="images/arrived.jpg" alt="Product Thumbnail" className="tab-image" />
                                            </a>
                                        </figure>
                                        <div className="d-flex flex-column text-center">
                                            <h3 className="fs-6 fw-normal">PUMA 38211108 BLACK/WHITE MEN'S FLIP FLOP SLIPPER</h3>
                                            <div>
                                            ...
                                            <div className="d-flex justify-content-center align-items-center gap-2">
                                                <del>$53.00</del>
                                                <span className="text-dark fw-semibold">$789.00</span>
