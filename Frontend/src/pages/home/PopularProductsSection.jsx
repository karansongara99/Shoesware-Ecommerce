                                    ...
                                    <div className="product-item swiper-slide">
                                        <figure>
                                            <a href="index.html" title="Product Title">
                                                <img src="images/popular.jpg" alt="Product Thumbnail" className="tab-image" />
                                            </a>
                                        </figure>
                                        <div className="d-flex flex-column text-center">
                                            <h3 className="fs-6 fw-normal">Milos / Corey Dark Mahogany Toe Cap Oxford Shoes</h3>
                                            <div>
                                            ...
                                            <div className="d-flex justify-content-center align-items-center gap-2">
                                                <del>$245.00</del>
                                                <span className="text-dark fw-semibold">$187.00</span>
