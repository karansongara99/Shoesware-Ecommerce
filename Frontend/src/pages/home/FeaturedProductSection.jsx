                                    ...
                                    <div className="product-item swiper-slide">
                                        <figure>
                                            <a href="index.html" title="Product Title">
                                                <img src="images/featured.png" alt="Product Thumbnail" className="tab-image" />
                                            </a>
                                        </figure>
                                        <div className="d-flex flex-column text-center">
                                            <h3 className="fs-6 fw-normal">Men's White Color Block Sneakers</h3>
                                            <div>
                                            ...
                                            <div className="d-flex justify-content-center align-items-center gap-2">
                                                <del>$240.00</del>
                                                <span className="text-dark fw-semibold">$180.00</span>
