                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-3 col-md-6 col-sm-6">
                            <div className="footer-menu">
                                <img src="images/logo-2.jpeg" width="240" height="170" alt="logo" />
                        ...
                        <div className="col-md-2 col-sm-6">
                            <div className="footer-menu">
                                <h5 className="widget-title">SkylineShopper</h5>
                ...
                <div className="container-lg">
                    <div className="row">
                        <div className="col-md-6 copyright">
                            <p>© 2024 SkylineShopper. All rights reserved.</p>
                        </div>
                        <div className="col-md-6 credit-link text-start text-md-end">
                            <p>Developed By Karan Sonagara </p>
                        </div>
                    </div>
                </div>
            </div>
